      ...
      <div className="w-full max-w-screen-xl mx-auto px-4">
        <nav className="flex items-center justify-between py-4">
          ...
          <div className="hidden md:flex items-center gap-2">
            <button className="flex items-center cursor-pointer gap-2 px-4 py-2 bg-transparent border border-[#006450] text-[#006450] rounded hover:bg-[#E6F5F1] transition ">
              <LogIn size={18} />
              <span>Accedi</span>
            </button>
            <button className="flex items-center cursor-pointer gap-2 px-4 py-2 bg-[#006450] text-white rounded hover:bg-green-700 transition">
              <UserPlus size={18} />
    ...
    >
      <div className="w-full max-w-3xl px-8 flex flex-col items-center text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button className="bg-[#006450] cursor-pointer text-white px-8 py-4 rounded hover:bg-green-700 transition transform hover:scale-105 flex items-center justify-center gap-2 font-semibold">
            <UserPlus size={20} />
            Registrati Ora
          </button>
          <button className="bg-transparent cursor-pointer border border-[#006450] text-[#006450] px-15 py-4 rounded hover:scale-105 bg-[#E6F5F1] transition flex items-center justify-center gap-2 font-semibold">
            <LogIn size={20} />
            Accedi
          </button>
        </div>
      ...
      <div className="w-full max-w-screen-xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {servizi.map((servizio) => (
            <div
              key={servizio.id}
              className="bg-white p-6 rounded-2xl shadow hover:shadow-xl transition-shadow cursor-pointer transform hover:-translate-y-1 transition-transform text-center"
            >
